...
class TestImplementationPlan(unittest.TestCase):
    ...
    def test_import(self):
        ...
        from implementation.implementation_plan import (
            ImplementationPlan, Phase, Milestone, Task,
            PhaseType, TaskStatus, TaskPriority
        )
    ...
    def test_task_creation(self):
        """測試任務創建"""
        from implementation.implementation_plan import Task, TaskStatus, TaskPriority
...
class TestSuccessMetrics(unittest.TestCase):
    ...
    def test_import(self):
        ...
        from implementation.success_metrics import (
            SuccessMetricsTracker, TechnicalMetric, BusinessMetric,
            OrganizationalMetric, MetricCategory
        )
    ...
    def test_record_value(self):
        """測試記錄指標值"""
        from implementation.success_metrics import (
            SuccessMetricsTracker, MetricCategory
        )
...
class TestActionGuide(unittest.TestCase):
    ...
    def test_import(self):
        ...
        from implementation.action_guide import (
            ActionGuide, ActionItem, Recommendation,
            StrategyEvaluator, ActionPriority
        )
    ...
    def test_recommendation_creation(self):
        """測試建議創建"""
        from implementation.action_guide import (
            Recommendation, RecommendationType, ActionPriority
        )
...
class TestIntegration(unittest.TestCase):
    ...
    def test_full_workflow(self):
        """測試完整工作流程"""
        from implementation.implementation_plan import ImplementationPlan
        from implementation.success_metrics import SuccessMetricsTracker, MetricCategory
        from implementation.action_guide import ActionGuide
