# =============================================================================
# SynergyMesh Governance - Rollback Governance Policy
...
# =============================================================================
metadata := {
    "dimension_id": "48-rollback",
    "dimension_name": "Rollback Governance",
    "version": "1.0.0",
    "tags": ["rollback", "revert", "recovery", "safety"]
}
