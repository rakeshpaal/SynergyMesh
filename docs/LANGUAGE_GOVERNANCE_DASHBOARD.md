...
> **Generated by:** Living Knowledge Base + AI Auto-Fix Bot + Language Policy
> Pipeline
...
- **Refactor Playbook Generator**: `tools/generate-refactor-playbook.py` ⭐
  **NEW**
...
**注意：** Health
Score 越低代表該 cluster 狀態越健康。高分數表示有較多治理問題需要處理。
...
- **Playbook Updates**: `.github/workflows/update-refactor-playbooks.yml` ⭐
  **NEW**
