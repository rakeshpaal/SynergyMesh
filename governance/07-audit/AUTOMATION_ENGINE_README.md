# Audit Governance Automation Engine

> Autonomous automation engine for Audit Governance
...
```python
from automation_engine import AuditGovernanceEngine

engine = AuditGovernanceEngine(Path(__file__).parent)
