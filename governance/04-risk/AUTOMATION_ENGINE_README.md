# Risk Governance Automation Engine

> Autonomous automation engine for Risk Governance
...
```python
from automation_engine import RiskGovernanceEngine

engine = RiskGovernanceEngine(Path(__file__).parent)
