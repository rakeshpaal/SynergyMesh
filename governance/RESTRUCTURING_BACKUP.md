...
- 20-information → 21-information (moved to next available number, but 21-ecological exists, so use different approach)
- 30-integration → Will consolidate into 30-agents or create coordination subdirectory
...
### Preserve 07-audit
Keep 07-audit as it serves strategy-level audit (policy definition), distinct from 70-audit (execution audit trail)
